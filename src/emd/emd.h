...
typedef struct
{
	...
	const float *Weights;	  /* Pointer to the weights of the features */
} signature_t;
...
float emd(const signature_t *Signature1, const signature_t *Signature2,
		  float (*func)(const feature_t *, const feature_t *), flow_t *Flow, int *FlowSize);
