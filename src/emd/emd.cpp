...
static float init(const signature_t *Signature1, const signature_t *Signature2,
...
static void addBasicVariable(int minI, int minJ, double *S, double *D, node1_t *PrevUMinI,
							 node1_t *PrevVMinJ, node1_t *UHead);
#if DEBUG_LEVEL > 0
...
float emd(const signature_t *Signature1, const signature_t *Signature2, float (*Dist)(const feature_t *, const feature_t *),
