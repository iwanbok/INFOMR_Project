...
#define CCD_INIT(ccd)                                                                              \
	 ...
	 */
	_ccd_export int ccdGJKSeparate(const void *obj1, const void *obj2, const ccd_t *ccd,
								   ccd_vec3_t *sep);
	 ...
	 * If memory allocation fails -2 is returned.
	 */
	_ccd_export int ccdGJKPenetration(const void *obj1, const void *obj2, const ccd_t *ccd,
	 ...
	 */
	_ccd_export int ccdMPRPenetration(const void *obj1, const void *obj2, const ccd_t *ccd,
									  ccd_real_t *depth, ccd_vec3_t *dir, ccd_vec3_t *pos);
